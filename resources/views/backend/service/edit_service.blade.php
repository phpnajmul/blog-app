...
@section('content')
        <form action="{{ route('update.service',$editData->id) }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    type="file"
                                    id="formFile" />
                                <img src="{{  (!empty($editData->logo))? url('upload/backend/service/'.$editData->logo):url('upload/no_image.jpg') }}" class="w-16 h-16 mb-6 border border-white shadow-md mt-1 rounded-md">
                            </div>
                            @error('logo')
